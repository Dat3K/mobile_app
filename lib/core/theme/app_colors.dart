...
class AppColors {
  ...
  static const Color backgroundSecondary = Color(0xFFF7F9FC);
  static const Color backgroundTertiary = Color(0xFFF0F4F8);
  ...
  static const Color warning = Color(0xFFFBAB00);
